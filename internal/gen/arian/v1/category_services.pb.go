...
const file_arian_v1_category_services_proto_rawDesc = "" +
	"\n" +
	" arian/v1/category_services.proto\x12\barian.v1\x1a\x17arian/v1/category.proto\x1a google/protobuf/field_mask.proto\x1a\x1fgoogle/protobuf/timestamp.proto\"\x8c\x01\n" +
	...
	"\x06filter\x18\x03 \x01(\tH\x02R\x06filter\x88\x01\x01B\b\n" +
	"\x06_limitB\t\n" +
	"\a_offsetB\t\n" +
	"\a_filter\"m\n" +
	...
	"\bcategory\x18\x01 \x01(\v2\x12.arian.v1.CategoryR\bcategory\"W\n" +
	"\x15CreateCategoryRequest\x12\x12\n" +
	"\x04slug\x18\x01 \x01(\tR\x04slug\x12\x14\n" +
	"\x05label\x18\x02 \x01(\tR\x05label\x12\x14\n" +
	"\x05color\x18\x03 \x01(\tR\x05color\"H\n" +
	"\x16CreateCategoryResponse\x12.\n" +
	"\bcategory\x18\x01 \x01(\v2\x12.arian.v1.CategoryR\bcategory\"\xd0\x01\n" +
	...
	"\bcategory\x18\x01 \x01(\v2\x12.arian.v1.CategoryR\bcategory\"'\n" +
	"\x15DeleteCategoryRequest\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\x03R\x02id\"=\n" +
	"\x16DeleteCategoryResponse\x12#\n" +
	"\raffected_rows\x18\x01 \x01(\x03R\faffectedRows\"\xf0\x01\n" +
	...
	"\bcategory\x18\x01 \x01(\v2\x12.arian.v1.CategoryR\bcategory\"\x9d\x02\n" +
	...
	"\bend_date\x18\x03 \x01(\v2\x1a.google.protobuf.TimestampH\x01R\aendDate\x88\x01\x01\x12\x19\n" +
	"\x05limit\x18\x04 \x01(\x05H\x02R\x05limit\x88\x01\x01\x12\x1b\n" +
	"\x06offset\x18\x05 \x01(\x05H\x03R\x06offset\x88\x01\x01B\r\n" +
	"\v_start_dateB\v\n" +
	"\t_end_dateB\b\n" +
	"\x06_limitB\t\n" +
	"\a_offset\"u\n" +
	...
	"\x05stats\x18\x02 \x01(\v2\x17.arian.v1.CategoryStatsR\x05stats\"^\n" +
	"\x1bBulkCreateCategoriesRequest\x12?\n" +
	"\n" +
	"categories\x18\x01 \x03(\v2\x1f.arian.v1.CreateCategoryRequestR\n" +
	"categories\"w\n" +
