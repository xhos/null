...
const file_arian_v1_category_services_proto_rawDesc = "" +
	"\n" +
	" arian/v1/category_services.proto\x12\barian.v1\x1a\x17arian/v1/category.proto\x1a google/protobuf/field_mask.proto\x1a\x1bbuf/validate/validate.proto\"\x17\n" +
	...
	"\bcategory\x18\x01 \x01(\v2\x12.arian.v1.CategoryR\bcategory\"\x96\x01\n" +
	"\x15CreateCategoryRequest\x12;\n" +
	"\x04slug\x18\x01 \x01(\tB'\xbaH$r\"\x10\x01\x18d2\x1c^[a-z0-9]+([._-][a-z0-9]+)*$R\x04slug\x12\x1f\n" +
	"\x05label\x18\x02 \x01(\tB\t\xbaH\x06r\x04\x10\x01\x18dR\x05label\x12\x1f\n" +
	"\x05color\x18\x03 \x01(\tB\t\xbaH\x06r\x04\x10\x01\x18\x14R\x05color\"H\n" +
	"\x16CreateCategoryResponse\x12.\n" +
	"\bcategory\x18\x01 \x01(\v2\x12.arian.v1.CategoryR\bcategory\"\x98\x02\n" +
	"\x15UpdateCategoryRequest\x12\x17\n" +
	"\x02id\x18\x01 \x01(\x03B\a\xbaH\x04\"\x02 \x00R\x02id\x12;\n" +
	"\vupdate_mask\x18\x02 \x01(\v2\x1a.google.protobuf.FieldMaskR\n" +
	"updateMask\x12@\n" +
	"\x04slug\x18\x03 \x01(\tB'\xbaH$r\"\x10\x01\x18d2\x1c^[a-z0-9]+([._-][a-z0-9]+)*$H\x00R\x04slug\x88\x01\x01\x12$\n" +
	"\x05label\x18\x04 \x01(\tB\t\xbaH\x06r\x04\x10\x01\x18dH\x01R\x05label\x88\x01\x01\x12$\n" +
	"\x05color\x18\x05 \x01(\tB\t\xbaH\x06r\x04\x10\x01\x18\x14H\x02R\x05color\x88\x01\x01B\a\n" +
	"\x05_slugB\b\n" +
	"\x06_labelB\b\n" +
	"\x06_color\"H\n" +
	...
	"\x18GetCategoryBySlugRequest\x12;\n" +
	"\x04slug\x18\x01 \x01(\tB'\xbaH$r\"\x10\x01\x18d2\x1c^[a-z0-9]+([._-][a-z0-9]+)*$R\x04slug\"K\n" +
...
var file_arian_v1_category_services_proto_depIdxs = []int32{
	14, // 0: arian.v1.ListCategoriesResponse.categories:type_name -> arian.v1.Category
	14, // 1: arian.v1.GetCategoryResponse.category:type_name -> arian.v1.Category
	14, // 2: arian.v1.CreateCategoryResponse.category:type_name -> arian.v1.Category
	15, // 3: arian.v1.UpdateCategoryRequest.update_mask:type_name -> google.protobuf.FieldMask
	14, // 4: arian.v1.UpdateCategoryResponse.category:type_name -> arian.v1.Category
	14, // 5: arian.v1.GetCategoryBySlugResponse.category:type_name -> arian.v1.Category
	0,  // 6: arian.v1.CategoryService.ListCategories:input_type -> arian.v1.ListCategoriesRequest
	2,  // 7: arian.v1.CategoryService.GetCategory:input_type -> arian.v1.GetCategoryRequest
	10, // 8: arian.v1.CategoryService.GetCategoryBySlug:input_type -> arian.v1.GetCategoryBySlugRequest
	4,  // 9: arian.v1.CategoryService.CreateCategory:input_type -> arian.v1.CreateCategoryRequest
	6,  // 10: arian.v1.CategoryService.UpdateCategory:input_type -> arian.v1.UpdateCategoryRequest
	8,  // 11: arian.v1.CategoryService.DeleteCategory:input_type -> arian.v1.DeleteCategoryRequest
	12, // 12: arian.v1.CategoryService.ListCategorySlugs:input_type -> arian.v1.ListCategorySlugsRequest
	1,  // 13: arian.v1.CategoryService.ListCategories:output_type -> arian.v1.ListCategoriesResponse
	3,  // 14: arian.v1.CategoryService.GetCategory:output_type -> arian.v1.GetCategoryResponse
	11, // 15: arian.v1.CategoryService.GetCategoryBySlug:output_type -> arian.v1.GetCategoryBySlugResponse
	5,  // 16: arian.v1.CategoryService.CreateCategory:output_type -> arian.v1.CreateCategoryResponse
	7,  // 17: arian.v1.CategoryService.UpdateCategory:output_type -> arian.v1.UpdateCategoryResponse
	9,  // 18: arian.v1.CategoryService.DeleteCategory:output_type -> arian.v1.DeleteCategoryResponse
